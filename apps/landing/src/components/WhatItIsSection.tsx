...
export default function WhatItIsSection() {
  return (
    <section id="what-it-is" className="relative bg-cream-50">
      <SectionFrame className="px-6 md:px-12 lg:px-20">
        <div className="pt-40 p-10 md:p-18">
          ...
          >
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-normal leading-tight text-warm-text max-w-3xl">
            Scale across Africa with the infrastructure{' '}
              <span className="bg-gradient-to-r from-[#e85d4a] to-[#8b5cf6] bg-clip-text text-transparent">
              global leaders trust
              </span>
            </h2>
