...
export default function MissionStatement() {
  return (
    <section id="mission" className="bg-cream-50">
      <div className="max-w-cinema mx-auto px-6 md:px-12 lg:px-20 py-24 md:py-36">
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-normal leading-tight tracking-tight text-warm-text">
            We are building the payment layer for China–Africa trade.
          </h2>
          <p className="mt-6 md:mt-8 text-base md:text-lg text-warm-muted leading-body max-w-2xl">
