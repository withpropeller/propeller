...
describe('SCryptHash', () => {
    ...
    it('should accept options', async () => {
        ...
        const checkCustomOpts = await SCryptHash.verify(testPasswordCorrect, hash, customOptions);
        const checkCustomOptsIncorrect = await SCryptHash.verify(testPasswordIncorrect, hash, customOptions);
    ...
    it('should ignore incorrect options', async () => {
        ...
        const checkCustomOpts = await SCryptHash.verify(testPasswordCorrect, hash, { saltLen, hashLen });
