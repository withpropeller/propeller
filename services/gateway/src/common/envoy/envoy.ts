...
export class EnvoyEvent<T = any> {
    ...
    static newKybEvent(data: { event: string; businessId: string; [key: string]: any }) {
        return this.new(TenantDataSource.Core, EnvoyEventStream.KybStream, data);
    }

    static newBusinessEvent(data: { event: string; businessId: string; [key: string]: any }) {
        return this.new(TenantDataSource.Core, EnvoyEventStream.BusinessStream, data);
    }
