...
import { HttpStatusCode, RawAxiosResponseHeaders, AxiosHeaders, RawAxiosRequestHeaders, AxiosRequestConfig, AxiosError } from 'axios';
...
export class RequestService {
    ...
    private prepareRequest(url: string,
        ...
        additionalConfigs?: AxiosRequestConfig): AxiosRequestConfig {
        ...
        return { method, url: apiBase + url, data, headers: combinedHeaders, params, ...additionalConfigs };
    }
    ...
    protected sendGetRequest(url: string,
        ...
        return this.sendRequest(url, undefined, 'GET', paramsObject, headers, apiBase, additionalConfigs);
     ...
     * @param {string} apiBase
     */
    protected sendDeleteRequest(url: string,
        paramsObject?: Record<string, string>,
        headers?: AxiosHeaders,
        apiBase?: string) {
    ...
    * @param {string} apiBase
    */
    protected sendPatchRequest(url: string,
        body?: object,
        headers?: AxiosHeaders,
        apiBase?: string) {
     ...
     * @param {string} apiBase
     */
    protected sendPutRequest(url: string,
        body?: object,
        paramsObject?: Record<string, string>,
        headers?: AxiosHeaders,
        apiBase?: string) {

        return this.sendRequest(url, body, 'PUT', paramsObject, headers, apiBase);
     ...
     * @param {string} apiBase
     */
    protected sendPostRequest(url: string,
        body?: object,
        headers?: AxiosHeaders,
        apiBase?: string) {
     ...
     * @return {Observable<RResponse>}
     */
    protected sendRequest(url: string,
        body?: Object,
        ...
        const requestConfig = this.prepareRequest(url, body, method, paramsObject, headers, apiBase, additionalConfigs);
    ...
    private catchErrors<T>(err: AxiosError<RResponseData<T>>): RResponse {
        if (err.code === 'ECONNREFUSED') {
            return {
                ...
                data: { code: AppStatus.ServiceUnavailable, error: 'Service Unavailable' },
                headers: null,
            };
        }
