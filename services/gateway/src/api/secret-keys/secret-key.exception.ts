...
export class SecretKeyException extends CustomException {
    ...
    public static get SecretKeyAlreadyTerminated() {
        return new this('Secret key already terminated', AccessKeyErrors.AccessKeyAlreadyTerminated, HttpStatus.BAD_REQUEST);
    }
}
