...
export class CustomerException extends CustomException {
    ...
    public static get ClaimsRequired() {
        return new this('Customer claims required', CustomerErrors.ClaimsRequired);
    }

    public static get ClaimsIncomplete() {
        return new this('Customer claims incomplete', CustomerErrors.ClaimsIncomplete);
    }

    public static get VerificationLevelInsufficient() {
        return new this('Customer verification level not sufficient', CustomerErrors.VerificationLevelInsufficient);
    }

    public static get VerificationRequired() {
        return new this('Customer verification required', CustomerErrors.VerificationRequired);
    }
}
