...
export class RequestService {
    ...
    private prepareRequest(
        ...
        let dataOrStr: string | Record<string, string> = data;
        ...
        if (data && headers.get('Content-Type') === 'application/x-www-form-urlencoded' && method === 'POST') {
            dataOrStr = new URLSearchParams(data).toString();
        }
     ...
     * @param {string} apiBase
     */
    protected sendPatchRequest(url: string, body?: Record<string, string>, headers?: AxiosHeaders, apiBase?: string) {
     ...
     * @param {string} apiBase
     */
    protected sendPutRequest(url: string, body?: Record<string, string>, headers?: AxiosHeaders, apiBase?: string) {
